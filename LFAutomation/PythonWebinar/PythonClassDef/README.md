LFAutomation contains class definitions for automation functions, which provides examples for how to load a new instance, call experiment functions, process captured data, and more
