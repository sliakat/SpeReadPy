...
%
%the Acquire call now will look for extra parameters (if exists). See 
%   documentation in picamMex.cpp

numLoops = 2;  %start with a small number to make sure the program is working the way you expect
                
errOpen = picamMex(0, 1);
if errOpen==0
    for i = 1:numLoops
        [errAcq,outData] = picamMex(1, 1, i*1000, 1, 50);
